...
export const incidents: Incident[] = [
  {
    ...
    assignedRunbook: "High CPU Remediation",
    ...
    resolvedAt: null,
    timeline: [
      { id: "t1", timestamp: "14:32", type: "created", description: "Opened from Datadog monitor: api-prod-01 CPU > 95% (5m)" },
      { id: "t2", timestamp: "14:33", type: "assigned", description: "Routed to on-call (Sarah Chen)", user: "System" },
      { id: "t3", timestamp: "14:34", type: "acknowledged", description: "Acknowledged; paging secondary on-call", user: "Sarah Chen" },
      { id: "t4", timestamp: "14:35", type: "severity_changed", description: "Escalated severity to critical", user: "Sarah Chen" },
      { id: "t5", timestamp: "14:36", type: "updated", description: "Started runbook: High CPU Remediation (step 1–2 in progress)", user: "Sarah Chen" },
      { id: "t6", timestamp: "14:38", type: "comment", description: "Heap stable; suspect hot loop in request batching after deploy v2.4.1", user: "Sarah Chen" },
    ],
    notes: [
      ...
      { id: "n3", user: "Sarah Chen", timestamp: "14:42", content: "Runbook: confirmed host api-prod-01; top shows java worker pinned — collecting thread dump." },
    ],
    review: {
      summary: "",
      rootCause: "",
  ...
  },
  {
    ...
    status: "open",
    category: "database",
    assignedRunbook: "Database Connection Recovery",
    assignedTo: null,
    alertMergeCount: 0,
    ...
    resolvedAt: null,
    timeline: [
      { id: "t1", timestamp: "14:26", type: "created", description: "Opened from PagerDuty: PostgreSQL pool saturation (db-primary)" },
      { id: "t2", timestamp: "14:27", type: "updated", description: "PagerDuty escalated to infrastructure queue (no assignee yet)", user: "System" },
      { id: "t3", timestamp: "14:28", type: "comment", description: "pg_stat_activity: 100/100 connections; majority idle > 30m", user: "System" },
      { id: "t4", timestamp: "14:29", type: "comment", description: "Need owner to run Database Connection Recovery — paging DB on-call", user: "System" },
    ],
    notes: [
      { id: "n1", user: "System", timestamp: "14:28", content: "Automated analysis: 23 connections appear stale (idle > 30 minutes)" },
      { id: "n2", user: "Jordan Lee", timestamp: "14:31", content: "If you take this: start with terminate idle >30m, then verify app pool max vs PG max_connections." },
    ],
    review: {
      summary: "",
      rootCause: "",
  ...
  },
  {
    ...
    status: "open",
    category: "application",
    assignedRunbook: "Payment Service Error Triage",
    assignedTo: null,
    alertMergeCount: 0,
    isMajorIncident: false,
    ...
    resolvedAt: null,
    timeline: [
      { id: "t1", timestamp: "14:02", type: "created", description: "Opened from Sentry: PaymentProcessor spike (NPE in checkout)" },
      { id: "t2", timestamp: "14:04", type: "alert_merged", description: "Merged duplicate Sentry issue group into this incident", user: "System" },
      { id: "t3", timestamp: "14:06", type: "severity_changed", description: "Raised to critical — >1% checkout failures", user: "System" },
      { id: "t4", timestamp: "14:08", type: "comment", description: "No assignee yet; severity critical + unassigned — needs immediate owner", user: "System" },
    ],
    notes: [
      { id: "n1", user: "System", timestamp: "14:08", content: "Suggested owner: payments on-call. Runbook: Payment Service Error Triage." },
    ],
    review: {
      summary: "",
      rootCause: "",
  ...
  },
  {
    id: "INC-2839",
    source: "Grafana",
    title: "Checkout API brownout during peak traffic",
    description:
      "5xx rate on checkout-api climbed during a flash sale. Mitigated by traffic shed and payment client timeout bump; dependency latency traced to PSP handshake stalls.",
    severity: "high",
    status: "resolved",
    category: "application",
    assignedRunbook: "Payment Service Error Triage",
    ...
    updatedAt: "8 hr ago",
    resolvedAt: "2026-04-14T21:45:00Z",
    timeline: [
      { id: "t1", timestamp: "18:00", type: "created", description: "Opened from Grafana SLO burn: checkout error rate" },
      { id: "t2", timestamp: "18:04", type: "alert_merged", description: "Merged 2 duplicate alerts into this incident", user: "System" },
      { id: "t3", timestamp: "18:10", type: "assigned", description: "Assigned to incident lead (Sarah Chen)", user: "System" },
      { id: "t4", timestamp: "18:12", type: "acknowledged", description: "War room bridge opened; comms template posted", user: "Sarah Chen" },
      { id: "t5", timestamp: "18:30", type: "updated", description: "Mitigation live: shed non-checkout traffic; PSP timeout 3s → 6s", user: "Sarah Chen" },
      { id: "t6", timestamp: "21:45", type: "resolved", description: "Error budget stabilized; monitoring holds; post-incident review pending", user: "Sarah Chen" },
    ],
    notes: [
      {
        id: "n1",
        user: "Sarah Chen",
        timestamp: "18:35",
        content: "PSP dashboard showed elevated TLS negotiation time — not our cert rotation. Keeping circuit breaker work as follow-up.",
      },
      {
        id: "n2",
        user: "Alex Kim",
        timestamp: "19:10",
        content: "Ran Payment Service Error Triage steps 1–3; no bad deploy — external dependency contention.",
      },
    ],
    review: {
      summary: "",
      ...
      actionItems: [
        {
          id: "ai-2839-1",
          title: "Add client-side circuit breaker on payment gateway calls",
          owner: "Alex Kim",
          status: "open",
          dueAt: "2026-04-02",
        },
