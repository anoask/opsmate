...
import { AlertCircle, Clock, Download, Play } from 'lucide-react'
  ...
  return (
    <Sheet open={open} onOpenChange={onOpenChange}>
      <SheetContent className="w-full sm:max-w-2xl overflow-y-auto">
        ...
        {isLoading && (
          <div className="mt-6 flex items-center gap-2 rounded-lg border border-border/70 bg-secondary/35 px-3 py-2.5 text-sm text-muted-foreground">
            <Spinner className="size-4" />
            Refreshing runbook details...
          </div>
        )}
        ...
        {error && (
          <Alert className="mt-6 border-border/70 bg-card/70">
            ...
            <AlertTitle>Runbook sync notice</AlertTitle>
